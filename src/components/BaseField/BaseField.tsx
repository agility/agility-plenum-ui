...
const defaultStyles = 'border py-2 px-3 rounded-md text-sm leading-5 font-normal w-full border-gray-300 shadow-sm';
/** Base input field component */
const BaseField = (
    { onFocus, onBlur, id, name, type, defaultValue, isDisabled, maxLength = 100, placeholder, inputStyles = defaultStyles, onChange, onValueChange }: BaseFieldProps,
