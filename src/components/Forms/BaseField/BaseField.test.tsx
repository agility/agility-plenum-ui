...
describe('BaseField', () => {
    describe('Type param', () => {
        const availableTypes = ['text', 'email', 'number', 'password', 'search', 'tel', 'url', 'date', 'datetime-local', 'month', 'time', 'week', 'currency'];
    ...
    describe('Placeholder', () => {
        it('should pass the correct placeholder param', () => {
            const basefield = shallow(<BaseField type='text' name='text' id='text' placeholder="placeholder" />)
            expect(basefield.prop('placeholder')).toBe('placeholder')
        });
    });
    describe('isDisabled', () => {
        it('should apply the correct style and prop for the disabled state', () => {
            const basefield = shallow(<BaseField type='text' name='text' id='text' placeholder="placeholder" isDisabled={true} />)
