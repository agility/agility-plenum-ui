...
describe('Select component', () => {
    it('should display the label when label prop is provided', () => {
        // setup
        const SelectComponent: ShallowWrapper = shallow(
    ...
    it('should not show label when label prop is empty', () => {
        // setup
        const SelectComponent: ShallowWrapper = shallow(
            <Select options={options} id="select" name="select" label="" />
        );
        // test
    ...
    it('should have the correct class when disabled', () => {
        // setup
        const SelectComponent: ShallowWrapper = shallow(
            <Select options={options} id="select" name="select" isDisabled />
        );
        // test
    ...
    it('should have the correct class when in an error state', () => {
        // setup
        const SelectComponent: ShallowWrapper = shallow(
            <Select options={options} id="select" name="select" label="label" isError />
        );
        // test
    ...
    it('should trigger the callback on change event', () => {
        ...
        let value = '';
        const inputOptions = [
            { label: 'label', value: 'expectedValue1' },
            { label: 'label', value: 'expectedValue2' }
        ];
        const SelectComponent: ReactWrapper = mount(
            <Select
