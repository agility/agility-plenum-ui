...
describe('InputCta component', () => {
    it('should display the label', () => {
        // setup
        const inputcta: ShallowWrapper = shallow(<InputCta icon="QuestionMarkCircleIcon" ctaLabel="Label" align="left" isClear />);
        // test
    ...
    it('should have the correct class when isClear prop is false', () => {
        // setup
        const inputcta: ShallowWrapper = shallow(<InputCta icon="QuestionMarkCircleIcon" ctaLabel="Label" align="left" isClear={false} />);
        // test
